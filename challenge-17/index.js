(function() {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/g, "Gustavo França"));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/g, "jacarezinhense"));
    ...
    */
    ...
    console.log(text.replace(/O Centauro de Luvas/g, function(titulo) {
