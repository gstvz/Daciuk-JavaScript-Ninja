(function(win, doc) {
    ...
    */
    $button.addEventListener('click', function(event) {
        ...
        else if(!isValidEmail($inputEmail.value)) alert("Entre com um e-mail válido");
        else if(confirm('Tem certeza que deseja enviar o formulário?')) alert('Enviado com sucesso!');        
        else alert('Não enviado');        
    });
